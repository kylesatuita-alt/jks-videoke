...
// Cart, favorites, avatar — only for logged-in users
$cartCount = 0;
$cartRows  = [];
$favIds    = [];
...
<nav class="navbar">
    ...
    <div class="nav-right">
        <?php if ($isGuest): ?>
            <!-- Guest navbar: just Login and Register -->
            <a href="login.php" class="nav-link-btn" style="color:var(--gold); border-color:var(--gold-border); background:var(--gold-soft);">
            ...
            <a href="register.php" class="nav-link-btn">
                ...
                <span class="nav-btn-label">Register</span>
            </a>
        <?php else: ?>
            <!-- Logged-in navbar -->
    ...
    <div class="unit-grid" id="unitGrid">
        ...
        <div class="v-card" id="vcard-<?php echo $v['id']; ?>" data-status="<?php echo $v['today_status']; ?>">
            ...
            <div class="v-card-img">
                ...
                <button class="btn-fav <?php echo $isFav ? 'active' : ''; ?>" data-id="<?php echo $v['id']; ?>" <?php echo $isGuest ? 'data-guest="1"' : ''; ?> title="<?php echo $isFav ? 'Remove from favorites' : 'Add to favorites'; ?>">
...
<div class="modal-overlay" id="guestModal">
    <div class="guest-modal">
        <!-- Close button -->
        <button class="guest-modal-close" id="guestModalClose">
        ...
        <div class="guest-modal-icon">
            <svg viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <line x1="35" y1="47" x2="35" y2="55" stroke="#F5C518" stroke-width="2.5" stroke-linecap="round"/>
                <line x1="26" y1="55" x2="44" y2="55" stroke="#F5C518" stroke-width="2.5" stroke-linecap="round"/>
            </svg>
        </div>

        <!-- Text -->
        <div class="guest-modal-eyebrow">Members Only</div>
        <h2 class="guest-modal-title">Ready to Book?</h2>
        <p class="guest-modal-sub">
            Log in or create a free account to reserve units,<br>add to cart, and save your favorites.
        </p>

        <!-- Feature highlights -->
        <div class="guest-modal-features">
            <div class="guest-modal-feature">
        ...
        <div class="guest-modal-actions">
            <a href="login.php" class="guest-modal-btn-primary">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" width="16" height="16"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>
                Log In
            </a>
            <div class="guest-modal-divider">or</div>
            <a href="register.php" class="guest-modal-btn-secondary">
                Create Free Account
            </a>
        </div>
    </div>
